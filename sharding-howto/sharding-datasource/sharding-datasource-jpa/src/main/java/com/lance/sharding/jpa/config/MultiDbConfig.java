package com.lance.sharding.jpa.config;

import com.lance.sharding.jpa.config.datasource.DynamicDataSource;
import com.lance.sharding.jpa.config.prop.CustomDbProperties;
