...
angular.module('flowableApp').directive('optimalGrid', ['$compile', '$http', function ($compile, $http) {
    var directive = {};
...
angular.module('flowableApp').directive('jumpers', ['$compile', '$http', function ($compile, $http) {
    var directive = {};
    directive.restrict = 'A';
    directive.replace = true;
...
angular.module('flowableApp').directive('userPicture', ['$compile', '$http', function ($compile, $http) {
    var directive = {};
    directive.restrict = 'A';
    directive.replace = true;
