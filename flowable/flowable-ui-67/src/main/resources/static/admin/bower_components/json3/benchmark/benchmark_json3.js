...
;(function (window) {
    ...
    // Load Benchmark.
    var Benchmark = load('Benchmark', '../vendor/benchmark'), _ = load('_', '../vendor/lodash'),
        platform = load('platform', '../vendor/platform');
    if (!Benchmark.Suite) {
    ...
    if (!isBrowser) {
        suite.on('cycle', function (event) {
            ...
            var results = this.filter("successful"), fastest = results.filter("fastest"),
                slowest = results.filter("slowest");
