...
flowableAdminApp.controller('TaskController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q', 'gridConstants',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
        ...
        $scope.loadTask = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/tasks/' + $routeParams.taskId
        ...
        $scope.loadSubTasks = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/tasks/' + $scope.task.id + '/subtasks'
            }).success(function (data, status, headers, config) {
                $scope.subTasks = data;
        ...
        $scope.loadVariables = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/tasks/' + $scope.task.id + '/variables'
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadIdentityLinks = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/tasks/' + $scope.task.id + '/identitylinks'
            }).success(function (data, status, headers, config) {
...
flowableAdminApp.controller('CompleteModalInstanceCtrl',
    ['$rootScope', '$scope', '$modalInstance', '$http', 'task', function ($rootScope, $scope, $modalInstance, $http, task) {
        ...
        $scope.ok = function () {
            ...
            $http({
                method: 'POST',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/tasks/' + $scope.task.id,
