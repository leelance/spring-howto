...
flowableAdminApp.controller('CaseDefinitionController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q', 'gridConstants',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
        ...
        $scope.loadCaseInstances = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/case-definitions/' + $scope.definition.id + '/case-instances'
        ...
        $scope.loadJobs = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/case-definitions/' + $scope.definition.id + '/jobs'
            }).success(function (data, status, headers, config) {
                $scope.jobs = data;
        ...
        $scope.loadDecisionTables = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/case-definition-decision-tables/' + $scope.definition.id
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadFormDefinitions = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/case-definition-form-definitions/' + $scope.definition.id
            }).success(function (data, status, headers, config) {
        ...
        $scope.executeWhenReady(function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/case-definitions/' + $routeParams.definitionId
            }).success(function (data, status, headers, config) {
                $scope.definition = data;
...
flowableAdminApp.controller('EditCaseDefinitionCategoryModalCtrl',
    ['$rootScope', '$scope', '$modalInstance', '$http', 'definition', function ($rootScope, $scope, $modalInstance, $http, definition) {
        ...
        $scope.ok = function () {
            ...
            $http({
                method: 'PUT',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/case-definitions/' + $scope.model.id,
                data: data
            }).success(function (data, status, headers, config) {
