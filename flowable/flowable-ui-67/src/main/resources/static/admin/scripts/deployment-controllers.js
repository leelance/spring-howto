...
flowableAdminApp.controller('DeploymentController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q) {
        ...
        $scope.deleteDeployment = function () {
            ...
            modalInstance.result.then(function (result) {
                if (result === true) {
                    $http({
                        method: 'DELETE',
                        url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/deployments/' + $routeParams.deploymentId
        ...
        $scope.executeWhenReady(function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.adminContextRoot + 'rest/admin/process-definitions?deploymentId=' + $routeParams.deploymentId
            }).success(function (data, status, headers, config) {
