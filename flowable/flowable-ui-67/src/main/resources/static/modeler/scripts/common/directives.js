...
flowableModule.directive('selectPeoplePopover', ['$rootScope', '$http', '$popover', 'UserService', '$parse', function ($rootScope, $http, $popover, UserService, $parse) {
    var directive = {};
    directive.restrict = 'A';
    ...
    directive.link = function ($scope, $element, attrs) {
        ...
        if ($scope.ignoreContainer) {
            $scope.popover = $popover($element, {
                template: 'views/common/popover/select-people-popover.html?' +
...
flowableModule.directive('selectFunctionalGroupPopover', ['$rootScope', '$http', '$popover', 'FunctionalGroupService', '$parse',
    function ($rootScope, $http, $popover, FunctionalGroupService, $parse) {
        ...
        directive.link = function ($scope, $element, attrs) {
            ...
            if ($scope.ignoreContainer) {
                $scope.popover = $popover($element, {
                    template: 'views/common/popover/select-functional-group-popover.html?' +
                        Date.now(), placement: placement
                });
